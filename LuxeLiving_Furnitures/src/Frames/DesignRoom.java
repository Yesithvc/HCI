...
public class DesignRoom extends JFrame {
    ...
    public DesignRoom(int width, int height, int depth, int roomNumber, String shape, Color floorColor, Color leftWallColor, Color frontWallColor, Color rightWallColor) {
        ...
        visualize3DButton.setBackground(new Color(139, 69, 19)); // Hex #041DFF
    ...
    private void setFloorColor(Color floorColor) {
        ...
        if (floor != null) {
            ...
            floor.setOpaque(floorAppearance);
        }
    }
    ...
    private JPanel createFurniturePanel() {
        ...
        for (String type : furnitureTypes) {
            furniturePanel.add(createDraggableLabel("src/Resources/" + type.toLowerCase() + ".png", type));
        }

        JButton saveButton = new JButton("Save");
        saveButton.setBackground(new Color(0, 0, 255)); // Blue background
        ...
        deleteButton.setBackground(new Color(255, 0, 0)); // Red background
        ...
        // Add the buttons panel to the furniture panel
        furniturePanel.add(buttonsPanel);
